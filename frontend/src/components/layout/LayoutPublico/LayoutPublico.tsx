        ...
        <div className="footer__content">
          ...
          <div>
            ...
            <div className="footer__links">
              ...
              <a href={URL_WHATSAPP} className="footer__link" target="_blank" rel="noopener noreferrer">WhatsApp</a>
              <a href={URL_INSTAGRAM} className="footer__link" target="_blank" rel="noopener noreferrer">Instagram</a>
        ...
        <div className="footer__bottom">
          ...
          <div className="footer__social">
            <a
              ...
              aria-label="Instagram de TravelBqto"
              target="_blank"
            ...
            <a
              href={URL_WHATSAPP}
              className="footer__social-link"
              aria-label="WhatsApp de TravelBqto"
              target="_blank"
              rel="noopener noreferrer"
            >
