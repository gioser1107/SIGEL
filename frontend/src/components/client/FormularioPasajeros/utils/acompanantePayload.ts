...
import { normalizarDomicilioInline } from '../../../puntos-recogida/utils';
...
export function acompananteFormularioAPayload(
  ...
  return {
    ...
    puntos_recogida: domicilio.puntos_recogida
      ? [normalizarDomicilioInline(domicilio.puntos_recogida)]
      : undefined,
  };
}
