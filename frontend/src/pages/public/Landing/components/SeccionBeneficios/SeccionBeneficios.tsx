...
const DATOS_BENEFICIOS: Beneficio[] = [
    {
        ...
        titulo: 'Traslado incluido',
        descripcion: 'El bus te lleva y te trae. El punto de recogida lo coordinas con la agencia.'
    },
    {
        id: 2,
        ...
        descripcion: 'Elige fecha, asiento y reporta el pago desde la web o en taquilla.'
    },
    {
        id: 3,
        ...
        titulo: 'Guía de la agencia',
        descripcion: 'En cada salida va un guía de Travel Bqto, no un recorredor ajeno.'
    },
    {
        id: 4,
        ...
        descripcion: 'Descuentos por temporada y sorteos que anuncia la agencia.'
    }
];
    ...
    return (
        <section className="seccion-beneficios">
            <div className="seccion-beneficios__encabezado">
                <h2 className="seccion-beneficios__titulo">Qué incluye cada salida</h2>
                <p className="seccion-beneficios__subtitulo">Así trabajamos cada salida desde Barquisimeto</p>
            </div>
