...
INSERT INTO usuarios (rol_id, correo, hash_contrasena, nombre_completo, creado_en, actualizado_en)
...
INSERT INTO clientes (
  usuario_id, tipo_cliente, tipo_documento, numero_documento, nombre_completo,
